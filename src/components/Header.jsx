...
signOut(auth).then(() => {
  ...
  return (
    <div className=" flex justify-between absolute  w-full z-10 bg-gradient-to-b from-black to-transparent  p-2">
      <img
        src={netflixLogo}
        alt="logo"
        className="w-30 pl-5 object-cover"
      />
     {user && (
       <div className="flex items-center">
        <p className='font-bold text-2xl text-white m-4'>{user.displayName}</p>
